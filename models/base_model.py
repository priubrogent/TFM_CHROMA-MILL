...
class BaseModel():
    ...
    def validation(self, dataloader, current_iter, tb_logger, save_img=False, rgb2bgr=True, use_image=True, log=False):
        """Validation function.
        ...
        if self.opt['dist']:
            ...
            return self.nondist_validation(dataloader, current_iter, tb_logger, save_img, rgb2bgr, use_image= use_image, log=log)
    ...
    @master_only
    def save_network(self, net, optimizer, net_label, current_iter, param_key='params'):
        """Save networks and optimizer.
        ...
        save_path = os.path.join(self.opt['save_weights_dir'], save_filename)
    ...
    def load_network(self, net, load_path, strict=True, param_key='params'):
        ...
        # Load optimizer state dictionary if available
        if 'optimizer' in load_net:
            optimizer_state_dict = load_net['optimizer']
            self.optimizers[0].load_state_dict(optimizer_state_dict)
